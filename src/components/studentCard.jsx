        ...
        <div className="bg-white p-4 rounded-lg shadow-md mb-4">
            ...
            edit ? (
                <div className= "flex justify-between">
                    ...
                    <div className="flex gap-2 mt-2">       // Edit and Delete buttons when in edit mode
                        <button onClick={() => setEdit(false)} className="bg-green-500 text-white px-3 py-1 rounded-lg hover:bg-green-600">Save</button>
                ...
                <form>  // Form to edit student information when in edit mode
                    ...
                    <div>  // Edit and Cancel buttons when in edit mode
                        <button className= "bg-blue-500 text-white px-3 py-1 rounded-lg hover:bg-blue-600 mt-2" onClick={() => onEdit(student._id, draft)}>Save</button>
